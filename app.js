            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-0">
                ...
                <div class="p-8 lg:p-12 flex flex-col justify-center">
                    ...
                    <div class="prose prose-blue mb-8">
                        <div class="mt-4 mb-6">
                          <h4 class="font-bold text-gray-900 mb-2">Інформація про ПК:</h4>
                          <div class="space-y-1 text-gray-600 text-sm">${product.description}</div>
                          <ul class="space-y-1 text-gray-600 text-sm">
                            <li class="flex items-center"><i data-feather="check" class="w-4 h-4 text-green-500 mr-2"></i>${product.descPartOne}</li>
                            <li class="flex items-center"><i data-feather="check" class="w-4 h-4 text-green-500 mr-2"></i>${product.descPartTwo}</li>
                            <li class="flex items-center"><i data-feather="check" class="w-4 h-4 text-green-500 mr-2"></i>${product.descPartThree}</li>
                            <li class="flex items-center"><i data-feather="check" class="w-4 h-4 text-green-500 mr-2"></i>${product.descPartFour}</li>
                            <li class="flex items-center"><i data-feather="check" class="w-4 h-4 text-green-500 mr-2"></i>${product.descPartFive}</li>
                            <li class="flex items-center"><i data-feather="check" class="w-4 h-4 text-green-500 mr-2"></i>${product.descPartSix}</li>
